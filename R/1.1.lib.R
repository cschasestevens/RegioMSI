...
#'
#' @export
Regio.col.grad <- function(){
  viridis::viridis(12)
  }

#' RegioMSI Generic Plot Theme
#'
#' General theme used for plots generated by RegioMSI.
#'
#' @export
...
#'
#' General theme used for plotting ion images generated by RegioMSI.
#'
#' @export
Regio.theme2 <- function(){
  thm.gen <- ggplot2::theme(
    # Plot Title
    plot.title = ggplot2::element_text(
      hjust = 0.5,
